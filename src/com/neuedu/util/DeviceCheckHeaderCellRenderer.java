 ...
 *
 */
public class DeviceCheckHeaderCellRenderer implements TableCellRenderer {
	DeviceManageTableModelProxy tableModel;
    JTableHeader tableHeader;
    final JCheckBox selectBox;

    public DeviceCheckHeaderCellRenderer(final JTable table) {
        this.tableModel = (DeviceManageTableModelProxy) table.getModel();
    ...
    public Component getTableCellRendererComponent(JTable table, Object value, boolean isSelected, boolean hasFocus,
        ...
        JLabel label = new JLabel(DeviceEntity.ENTITY_TITLE[column]);
