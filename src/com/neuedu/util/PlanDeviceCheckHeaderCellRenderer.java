 ...
 *
 */
public class PlanDeviceCheckHeaderCellRenderer implements TableCellRenderer {
	PlanDeviceTableModelProxy tableModel;
    JTableHeader tableHeader;
    final JCheckBox selectBox;

    public PlanDeviceCheckHeaderCellRenderer(final JTable table) {
        this.tableModel = (PlanDeviceTableModelProxy) table.getModel();
    ...
    public Component getTableCellRendererComponent(JTable table, Object value, boolean isSelected, boolean hasFocus,
        ...
        JLabel label = new JLabel(PlanDeviceEntity.ENTITY_TITLE[column]);
