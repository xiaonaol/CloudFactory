 ...
 *
 */
public class ProductCheckHeaderCellRenderer implements TableCellRenderer {
	ProductTableModelProxy tableModel;
    JTableHeader tableHeader;
    final JCheckBox selectBox;

    public ProductCheckHeaderCellRenderer(final JTable table) {
        this.tableModel = (ProductTableModelProxy) table.getModel();
    ...
    public Component getTableCellRendererComponent(JTable table, Object value, boolean isSelected, boolean hasFocus,
        ...
        JLabel label = new JLabel(ProductEntity.ENTITY_TITLE[column]);
