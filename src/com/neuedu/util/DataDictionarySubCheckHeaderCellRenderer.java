 ...
 *
 */
public class DataDictionarySubCheckHeaderCellRenderer implements TableCellRenderer {
	DataDictionarySubTableModelProxy tableModel;
    JTableHeader tableHeader;
    final JCheckBox selectBox;

    public DataDictionarySubCheckHeaderCellRenderer(final JTable table) {
        this.tableModel = (DataDictionarySubTableModelProxy) table.getModel();
    ...
    public Component getTableCellRendererComponent(JTable table, Object value, boolean isSelected, boolean hasFocus,
        ...
        JLabel label = new JLabel(DataDictionarySubEntity.ENTITY_TITLE[column]);
