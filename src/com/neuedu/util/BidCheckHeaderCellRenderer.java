 ...
 *
 */
public class BidCheckHeaderCellRenderer implements TableCellRenderer {
	BidManageTableModelProxy tableModel;
    JTableHeader tableHeader;
    final JCheckBox selectBox;

    public BidCheckHeaderCellRenderer(final JTable table) {
        this.tableModel = (BidManageTableModelProxy) table.getModel();
    ...
    public Component getTableCellRendererComponent(JTable table, Object value, boolean isSelected, boolean hasFocus,
        ...
        JLabel label = new JLabel(BidEntity.ENTITY_TITLE[column]);
