 ...
 *
 */
public class OrderManageCheckHeaderCellRenderer implements TableCellRenderer {
	OrderManageTableModelProxy tableModel;
    JTableHeader tableHeader;
    final JCheckBox selectBox;

    public OrderManageCheckHeaderCellRenderer(final JTable table) {
        this.tableModel = (OrderManageTableModelProxy) table.getModel();
    ...
    public Component getTableCellRendererComponent(JTable table, Object value, boolean isSelected, boolean hasFocus,
        ...
        JLabel label = new JLabel(OrderEntity.ENTITY_TITLE[column]);
