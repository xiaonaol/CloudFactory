 ...
 *
 */
public class UserManageCheckHeaderCellRenderer implements TableCellRenderer {
	UserManageTableModelProxy tableModel;
    JTableHeader tableHeader;
    final JCheckBox selectBox;

    public UserManageCheckHeaderCellRenderer(final JTable table) {
        this.tableModel = (UserManageTableModelProxy) table.getModel();
    ...
    public Component getTableCellRendererComponent(JTable table, Object value, boolean isSelected, boolean hasFocus,
        ...
        JLabel label = new JLabel(UserEntity.ENTITY_TITLE[column]);
