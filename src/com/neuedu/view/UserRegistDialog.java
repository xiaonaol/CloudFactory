...
public class UserRegistDialog extends JDialog {
	...
	public static void main(String[] args) {
		try {
			UserRegistDialog dialog = new UserRegistDialog( null , null);
	 ...
	 * Create the dialog.
	 */
	public UserRegistDialog( UserManage _parentWindow , UserEntity _parentDate) {
